...
public class StaffNameGenerator {
	...
	protected String[] firstNames = { "Adao", "Draco", "Harry", "Hermione", "Jack", "Emily", "James", "Ava", "Daniel",
			...
			"Nisleine", "Maria", "Guardalupe", "Suely", "Eva", "Eliane", "Elizangela", "Leilla", "Walquiria",
			"Waldirene", "Wagner", "Terezinha", "Raoni", "Liana", "Guilherme", "Erick", "Willian", "Lanara", "Amilcar",
			"Edna", "Ilda", "Debora", "Lily", "Lilian", "Bruna", "Alysson", "Roberta", "Leticia", };
